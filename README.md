...
## ✔ 프로젝트 평가
+ 많은 인원이 함께 수행하는 프로젝트였기 때문에 의사소통이 매우 중요했으나, 개발 초기에 기획한 내용을 잘못 이해해서 시간을 꽤 허비했다. 이후, 동일한 문제가 발생하지 않도록 매일 팀원들과 개발 사항을 공유했다. 본 과제는 기존에 몰랐던 기법들을 학습하는 계기가 되었을 뿐만 아니라 **의사소통의 중요성**을 깨닫게 해주었다.
